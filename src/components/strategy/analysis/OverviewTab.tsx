...
import type { EventPerformanceData, ComparisonType } from '@/types/strategy'
import { VERDICT_STYLES, VerdictType } from './constants'
...
function getVerdictStyle(verdict: EventPerformanceData['verdict']) {
